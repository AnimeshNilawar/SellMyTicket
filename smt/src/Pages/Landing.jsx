...
import { Search, ChevronRight, Clock, MapPin, Heart, Star, Facebook, Twitter, Instagram, Youtube } from 'lucide-react';
...
export default function Landing() {
  ...
  const popularEvents = [
    ...
    {
      id: 2,
      title: 'Aakash Gupta Solo Stand-Up',
      date: 'APR 5',
      time: '8:00 PM',
    ...
    <div className="flex flex-col min-h-screen font-sans">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-4 gap-4 mb-4">
            {categories.map((category) => (
              <div key={category.id} className="bg-white rounded-lg overflow-hidden shadow-md">
                <img
                  src={category.image}
                  alt={category.name}
      ...
      <section className="bg-cyan-300 py-4 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative mb-4 h-96 overflow-hidden rounded-lg">
            <img
